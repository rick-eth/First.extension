# -*- coding: utf-8 -*-
__title__ = "Parametro das luvas aninhadas"                                       # Name of the button displayed in Revit UI
__doc__ = """Version = 1.0
Date    = 20.04.2022
...
from Autodesk.Revit.DB import Transaction, FilteredElementCollector, BuiltInCategory     # or Import only classes that are used.
# from Autodesk.Revit.DB.Architecture import Room, TopographySurface      # Import Discipline Specific Elements
from Autodesk.Revit.DB import *                                         # Import everything from DB (Very good for beginners)

# pyRevit
from pyrevit import revit, script, forms                                        # import pyRevit modules. (Lots of useful features)
...
from Snippets._inserir_parametro_aninhado import inserir_parametro_aninhado  # lib import
